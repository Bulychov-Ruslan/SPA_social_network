            ...
            <div class="p-12 bg-white border border-gray-200 rounded-lg">
                <form class="space-y-6" v-on:submit.prevent="submitForm">
                    <div>
                        ...
                        <input type="password" v-model="form.old_password" placeholder="Ваш старый пароль" class="w-full mt-2 py-4 px-6 border border-gray-200 rounded-lg">
                    </div>

                    <div>
                        <label>Новый пароль</label><br>
                        <input type="password" v-model="form.new_password1" placeholder="Ваш новый пароль" class="w-full mt-2 py-4 px-6 border border-gray-200 rounded-lg">
                    </div>
